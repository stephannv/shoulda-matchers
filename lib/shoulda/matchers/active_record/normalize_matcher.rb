    ...
    module ActiveRecord
      ...
      class NormalizeMatcher
        ...
        def attribute_matches?(subject, attribute)
          ...
          @failure_message = build_failure_message(attribute, subject.public_send(attribute))
          false
        end
        ...
        def normalize_attribute?(subject, attribute)
          subject.public_send("#{attribute}=", from_value)
          subject.normalize_attribute(attribute)

          subject.public_send(attribute) == to_value
        end
